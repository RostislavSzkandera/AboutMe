...
const AboutMe = () => {
  return (
    <div id="aboutMe" className="bg-blue-300 min-h-[800px] xl:h-[1000px] pt-40 sm:mt-96 ">
        <div className="md:w-3/4 mx-auto">
            
            <h2 className="text-xl lg:text-2xl xl:text-3xl text-center border-b border-white w-[30%] mx-auto pb-2 mb-8 font-bold uppercase ">O mně</h2>
            ...
            <div className="flex flex-row justify-center items-center mx-8">
                <img className="w-36 xl:w-96 mx-2 sm:hover:scale-125 duration-1000" src={image1} alt="" />
                <img className="w-36 xl:w-96 mx-2 sm:hover:scale-125 duration-1000" src={image2} alt="" />
                <img className="w-36 xl:w-96 mx-2 sm:hover:scale-125 duration-1000" src={image3} alt="" />
            </div>
